...
public class ReplyController {
    ...
    @RequestMapping(value = "/reply/replyOthers")
     ...
     * 添加评论de回复
     */
    @RequestMapping(value = "/reply/addOthers",method = RequestMethod.POST)
...
//        view.addObject("fatherCommentUser",fatherReplyUsername);
    ...
    @RequestMapping(value ="/reply/upload",method=RequestMethod.POST)
    @ResponseBody
