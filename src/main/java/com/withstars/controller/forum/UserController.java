...
public class UserController {
     ...
     * 用户注册
     */
    @RequestMapping("/forum/user/add/do")
    ...
    @RequestMapping("/forum/api/loginCheck")
    @ResponseBody
     ...
     * 用户个人主页
     */
    @RequestMapping("/forum/member/{username}")
    public ModelAndView personalCenter(@PathVariable("username")String username,HttpSession session){
        ...
        ModelAndView mv=new ModelAndView("forum/user_info");
    ...
    public ModelAndView settings(HttpServletRequest request, HttpSession session){
        ...
        ModelAndView mv=new ModelAndView("forum/settings");
        mv.addObject("user",user);
        mv.addObject("hotestTopics",hotestTopics);
        return mv;
    }

    @RequestMapping(value = "/forum/settings/avatar",method = RequestMethod.GET)
    public ModelAndView updateAvatar(HttpServletRequest request, HttpSession session){
        ...
        ModelAndView mv=new ModelAndView("forum/update_avatar");
        mv.addObject("user",user);
        mv.addObject("hotestTopics",hotestTopics);
        return mv;
    }
    ...
    @RequestMapping(value = "/forum/settings/avatar/update",method = RequestMethod.POST)
