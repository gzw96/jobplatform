        ...
        <span>
                                ...
                                <td>
                                    <div class="panel-group">
                                        ...
                                        <div style="width: 89%;float: left;margin-left: 60px;margin-top: -60px">
                                            <a href="/member/${pageInfo.list.get(status.index).user.username}"><strong>${pageInfo.list.get(status.index).user.username}</strong></a>&nbsp;&nbsp;
                                            <small class="text-muted">${pageInfo.list.get(status.index).localCreateTime}
                                            </small>
                                            <a href="/reply/replyOthers?fatherCommentId=${pageInfo.list.get(status.index).id}&topicId=${topic.id}">&nbsp;<strong>回复</strong></a>
            ...
            <script>
                ...
                $('[data-page]').on('click', function () {
                    ...
                    window.location.href = encodeURI('/t/${topic.id}?pageNum=' + pageNum);
                });
                //点击上一页
                ...
                <div class="form-group">
                    <form action="/reply/add" method="post">
                        ...
                        <script type="text/javascript">
                            ...
                            //图片上传
                            editor.customConfig.uploadImgServer = '/reply/upload'; //上传URL
