            ...
            <li class="list-group-item">
                <div style="height: 50px">
                    ...
                    <div style="width: 89%;float: left">
                        <a href="/forum/t/${unreadTopic.get(status.index).id}">${unreadTopic.get(status.index).title}</a><br/>
                        <div>
                        ...
                        <td>
                            <div class="panel-group">
                                ...
                                <div style="width: 89%;float: left;margin-left: 60px;margin-top: -60px">
                                    <a href="/forum/member/${unreadReply.get(status.index).user.username}"><strong>${unreadReply.get(status.index).user.username}</strong></a>&nbsp;&nbsp;
                                    ...
                                    <br/>
                                    <div>
                                        <a href="/forum/t/${unreadReply.get(status.index).topicId}?pageNum=${floorList.get(status.index)}">${unreadReply.get(status.index).content}</a>
                                    </div>
                                </div>
                            </div>
